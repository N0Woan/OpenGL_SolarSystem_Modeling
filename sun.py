...
class Sun(object):
    def __init__(self, radius, vert_shader, frag_shader):   
        self.vertices, self.indices, self.colors, self.texcoords = newsphere(radius, 30)     
    ...
    def setup(self):
        ...
        self.uma.setup_texture('texture0', '/home/n0woan/Source/Solar/resources/textures/earth.jpg')
        self.uma.setup_texture('texture1', '/home/n0woan/Source/Solar/resources/textures/moon.jpeg')
        self.uma.setup_texture('texture2', '/home/n0woan/Source/Solar/resources/textures/sun.png')
